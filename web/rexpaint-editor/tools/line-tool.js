/**
 * Line Tool - Draw lines of cells from start point to end point
 *
 * Draws lines between two points using Bresenham's line algorithm.
 * Press 'l' to activate, click start point, drag to end point, release to draw.
...
export class LineTool {
  ...
  /**
   * Start drawing a line at the given coordinates
  ...
  /**
   * Update the preview endpoint of the line
  ...
  endLine() {
    ...
    const cells = this._lineBresenham(this.lineStartX, this.lineStartY, this.lineEndX, this.lineEndY);

    // Paint each cell
    for (const cell of cells) {
      this._paint(cell.x, cell.y);
    }
