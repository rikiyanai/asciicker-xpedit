...
Do not start with random fuzzing. Start with a small, named recipe set.
...
- generic fuzzing across the whole UI
...
3. step-by-step invariant checks
4. structured failure artifact output
